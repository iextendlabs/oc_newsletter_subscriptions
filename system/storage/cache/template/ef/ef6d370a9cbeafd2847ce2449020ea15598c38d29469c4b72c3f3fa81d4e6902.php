...
/* catalog\view\template\product\product.twig */
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["attribute_group"]) {
                ...
                echo "                    <thead>
                      <tr>
                        <td colspan=\"2\"><strong>";
                // line 246
                echo twig_get_attribute($this->env, $this->source, $context["attribute_group"], "name", [], "any", false, false, false, 246);
                echo "</strong></td>
                      </tr>
                    </thead>
                    <tbody>
                ...
                // line 250
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["attribute_group"], "attribute", [], "any", false, false, false, 250));
                foreach ($context['_seq'] as $context["_key"] => $context["attribute"]) {
                    // line 251
                    echo "                        <tr>
                          <td>";
                    // line 252
                    echo twig_get_attribute($this->env, $this->source, $context["attribute"], "name", [], "any", false, false, false, 252);
                    echo "</td>
                          <td>";
                    // line 253
                    echo twig_get_attribute($this->env, $this->source, $context["attribute"], "text", [], "any", false, false, false, 253);
                    echo "</td>
                        </tr>
                      ";
                }
        ...
        if (($context["tags"] ?? null)) {
          ...
          ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                ...
                echo "</a>";
                if ( !twig_get_attribute($this->env, $this->source, $context["loop"], "end", [], "any", false, false, false, 278)) {
                    echo ",";
                }
                // line 279
                echo "          ";
...
";
    ...
    {
        return "catalog\\view\\template\\product\\product.twig";
    }
